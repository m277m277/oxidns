...
export const enUSPluginDefined = {
  ...
  kinds: {
    ...
    black_hole: {
      name: "Black Hole",
      description:
        "Directly returns the default address for hit A/AAAA requests",
      fields: {
        ips: {
          label: "return address",
          description: "Defines a set of local synthetic return addresses.",
          placeholder: "0.0.0.0\n::",
        },
        "ips[]": {
          label: "Enter value",
      ...
      metrics: {
        ...
        help: {
          blackhole_block_total:
            "black_hole The total number of times the local response was synthesized.",
        },
      },
    },
    drop_resp: {
